# Laravel Data objects to JSON Schemas
...
This package transforms [spatie/laravel-data](https://github.com/spatie/laravel-data) objects into JSON Schemas and includes built-in validation.
