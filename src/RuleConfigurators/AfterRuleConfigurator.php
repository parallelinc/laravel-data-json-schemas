...
class AfterRuleConfigurator implements ConfiguresStringSchema
{
    ...
    public static function configureStringSchema(
        ...
        $annotation = sprintf('The value must be after %s.', $dateString);

        return $schema->format(Format::DateTime)
            ->customAnnotation('date-after', $annotation);
    }
}
